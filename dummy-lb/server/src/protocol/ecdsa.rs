...
//              fixed key for test
                    let s1 = ECScalar::from(&BigInt::from_hex("7f8d5dfb3c8f99b1641d200e808dd0b6c52f53b04e972c2e61ab901133902ebd"));
                    MasterKey1::key_gen_first_message_predefined(s1)
...
//        }
        ...
        println!("{:?}", kg_first_msg);
        Ok((user_id, kg_first_msg))
    }

    fn second_message(&self, key_gen_msg2: KeyGenMsg2) -> Result<party1::KeyGenParty1Message2> {
        println!("{:?}", key_gen_msg2);
...
//        }
        ...
        println!("{:?}", kg_party_one_second_msg);
...
//        else {
            ...
            sign_party_one_first_msg = sign_party_one_first_message;
//        }
        println!("{:?}", sign_party_one_first_msg);
