...
mod tests {
    ...
    #[test]
    fn test_transfer_sign_keygen_const() {
        let lockbox_url: &str = &env::var("LOCKBOX_URL").unwrap_or("http://0.0.0.0:8000".to_string());
        ...
        // generate a secret key share
        let key_share_priv: FE = ECScalar::from(&BigInt::from_hex("706a20e8ea1c85cfcb38ab939fac5454868dcc3c912841e3320e7d7601fccdc3"));
        ...
        let o1 = master_key.private.get_private_key();
        let x1 = ECScalar::from(&BigInt::from_hex("e3b378caeb6738f8c5c7dc1b4537170c9d3ed1484949da7f6ca3717c3023de18"));
        let t1 = o1 * x1;
        let o2: FE = ECScalar::from(&BigInt::from_hex("a79b24691cdd10da2d54f1617a60e34d27c9e02b46420b0ca2aa5fcfa41dc65f"));
