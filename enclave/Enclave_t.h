...
sgx_status_t create_sealeddata_for_serializable(uint8_t* sealed_log, uint32_t sealed_log_size);
sgx_status_t verify_sealeddata_for_serializable(uint8_t* sealed_log, uint32_t sealed_log_size);
