        ...
        let rock = rocket::custom(rocket_config)
            ...
            .mount(
                ...
                routes![
                    ...
                    ecdsa::sign_first,
                    ecdsa::sign_second,
                    transfer::keyupdate_first,
                    transfer::keyupdate_second,
                    util::get_statechain,
                    util::get_smt_root,
...
mock! {
    ...
    trait Transfer {
        ...
        fn keyupdate_first(&self, ku_send: KUSendMsg) -> transfer::Result<KUReceiveMsg>;
        fn keyupdate_second(&self, ku_fin: KUFinalize) -> transfer::Result<KUAttest>;
    }
    trait BatchTransfer {
